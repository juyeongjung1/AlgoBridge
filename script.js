...
const problems = [
  ...
  makeProblem({
    ...
    explanation: [["2つの整数を受け取る", "比較する値を a と b に設定します。比較前に両方の値が用意できていれば、入力順は入れ替わっても構いません。"], ["if で比較する", "a が b 以上かを調べます。真なら a、偽なら else の中で b を表示します。"], ["条件ごとに値を出力する", "同じ値の場合も a を出力できるため、以上（>=）を使います。"]],
