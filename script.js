...
const problems = [
  ...
  makeProblem({
    id: "max", category: "選択", title: "max を使って大きい方を表示", inputNote: "2つの整数を入力してください。", description: "2つの整数を受け取り、大きい方の値を変数 <code>max</code> に格納してから表示してください。", inputs: [I("a", "入力値 a", 12), I("b", "入力値 b", 7)],
